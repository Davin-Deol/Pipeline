    ...
    @if (count($savedListings))
        @foreach ($savedListings as $savedListing)
            ...
            <div class="row field" id="{{ $listing->listingID }}">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <a href="{{ route('user-reviewListing', ['listingID' => $listing->listingID]) }}" class="btn btn-default button">Details</a>
                    </div>
                    <div class="col-xs-6">
                        <button class="removeSavedListing btn btn-default button" value="{{ $listing->listingID }}">Remove</button>
                    </div>
                </div>
            </div>
