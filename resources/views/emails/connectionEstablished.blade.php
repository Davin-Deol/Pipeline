...
<body style="font-family: 'Helvetica Neue', HelveticaNeue, 'TeX Gyre Heros', TeXGyreHeros, FreeSans, 'Nimbus Sans L', 'Liberation Sans', Arimo, Helvetica, Arial, sans-serif; height: 100%; margin: 0px;">
    ...
    <div id="mainSection" style="width: 80%; margin: 0 auto; color: #777; text-align: center;">
        <p style="font-size: 2em;">Congratulations on your connection with {{ $otherParty->fullName }}! Now you can go to their profile and get into contact with them. To get to their profile, simply go to your profile and click their name on your list of connections.</p>
    </div>
</body>
</html>